...
from gtstencil_example.microph_func import *
from gtstencil_example import BACKEND, REBUILD, FIELD_FLOAT, DTYPE_INT, DTYPE_FLOAT
...
def fields_init( land   : FIELD_FLOAT, 
                 area   : FIELD_FLOAT, 
                 h_var  : FIELD_FLOAT, 
                 rh_adj : FIELD_FLOAT, 
                 rh_rain: FIELD_FLOAT, 
...
@gtscript.stencil(backend=BACKEND, rebuild=REBUILD)
def warm_rain( h_var     : FIELD_FLOAT, 
               rain      : FIELD_FLOAT, 
               qgz       : FIELD_FLOAT, 
               qiz       : FIELD_FLOAT, 
               qlz       : FIELD_FLOAT, 
...
@gtscript.stencil(backend=BACKEND, rebuild=REBUILD)
def sedimentation( graupel  : FIELD_FLOAT, 
                   ice      : FIELD_FLOAT, 
                   rain     : FIELD_FLOAT, 
                   snow     : FIELD_FLOAT, 
                   qgz      : FIELD_FLOAT, 
...
@gtscript.stencil(backend=BACKEND, rebuild=REBUILD)
def fields_update( graupel: FIELD_FLOAT, 
                   ice    : FIELD_FLOAT, 
                   rain   : FIELD_FLOAT, 
                   snow   : FIELD_FLOAT, 
                   qaz    : FIELD_FLOAT, 
